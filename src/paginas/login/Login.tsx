    ...
    return (
        ...
        <Grid container direction='row' justifyContent='center' alignItems='center'>
            <Grid xs={6} style={{
                ...
                backgroundImage: `url(https://image.winudf.com/v2/image1/cnUuYW5kcm9pZHRvb2xzLmhhY2tlcl9saXZlX3dhbGxwYXBlcl9tYXRyaXhfc2NyZWVuX3B0LUJSXzBfMTU2OTMwNzY5NF8wOTI/screen-0.webp?fakeurl=1&type=.webp)`,
            ...
            <Grid alignItems='center' xs={6}>
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <Box marginTop={5} width={400}>
                            <Typography variant='subtitle2' style={{ marginBottom: -15 }}>
                                Faça login para continuar</Typography> <br />
                ...
                <Box display='flex' justifyContent='center' marginTop={5}>
                    <Box marginRight={1}>
                        <Typography variant='subtitle1' gutterBottom align='center'>Ainda não é Inscrito?</Typography>
                    </Box>
                    <Link to='/cadastro'>
