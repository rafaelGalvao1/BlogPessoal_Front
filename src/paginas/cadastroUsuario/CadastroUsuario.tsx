...
function CadastroUsuario() {
    ...
    async function onSubmit(e: ChangeEvent<HTMLFormElement>) {
        ...
        if (confirmarSenha == usuario.senha) {
            cadastrarUsuario(`usuarios/cadastrar`, usuario, setUserResult)
            ...
            <Grid item xs={6} alignItems='center'>
                ...
                <Box paddingX={10}>
                    <Box marginBottom={7}>
                        ...
                        <Typography gutterBottom color='textPrimary' align='left' className='textos3'>Entre para a comunidade de DESENVOLVEDORES   </Typography>
                    </Box>
